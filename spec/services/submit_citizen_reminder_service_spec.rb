...
RSpec.describe SubmitCitizenReminderService, :vcr do
  ...
  describe '#send_email' do
    ...
    context 'sending the email' do
      let(:mail) { SubmitCitizenFinancialReminderMailer.notify_citizen(application.application_ref, smoke_test_email, application_url, application.applicant.full_name) }
