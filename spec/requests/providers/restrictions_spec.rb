    ...
    context 'when the provider is authenticated' do
      ...
      context 'Form submitted with continue button' do
        ...
        context 'when the citizen has completed the non-passported path' do
          let(:application) { create :legal_aid_application, :with_applicant, :non_passported, state: :provider_assessing_merits }
        ...
        context 'provider on passported route' do
          let(:application) { create :legal_aid_application, :with_applicant, :passported, state: :provider_assessing_merits }
